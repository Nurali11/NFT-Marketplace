...
const LangConfig = () => {
    ...
    return (
      <div className="lang-wrapper w-[70px] py-3 relative cursor-pointer">
          ...
          {langList
            ...
            .map((item: LangType) => (
              <div
                ...
                key={item.id}
                className="flex hover:bg-white hover:text-[var(--clr-violet)] p-2 rounded-md items-center gap-2 text-[14px] font-semibold"
              >
