...
const MagicMushrooms = () => {
    ...
    const t = useTranslations("Mashroom");
    return (
        <section style={{ backgroundImage: 'url("/mashroom.svg")', backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundAttachment:"fixed" }} className="h-[660px] flex justify-end pb-[60px] overflow-hidden">
            <div className="containers flex items-end w-full justify-between">
                <div>
                    ...
                    <h1 className="text-5xl my-[30px] font-bold text-white mb-8 bg-gradient-to-r from-white to-purple-200 bg-clip-text">{t("title")}</h1>
                    <button className="bg-white cursor-pointer backdrop-blur-sm border border-white/30 text-black px-8 py-3 rounded-full font-medium hover:bg-white/30 transition-all duration-300 flex items-center space-x-2">
                        <EyeIcon />
                        <span>{t("button")}</span>
                    </button>
                </div>
                <div className="bg-black/40 w-[300px] backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                    <div className="text-white/80 text-sm mb-2">{t("auction")}</div>
                    <div className="flex items-center space-x-4">
                        <div className="text-center">
                            <div className="text-4xl font-bold text-white">
                                {formatTime(timeLeft.hours)}
                            </div>
                            <div className="text-white/60 text-xs">{t("hours")}</div>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <div className="text-white/60 text-xs">{t("minutes")}</div>
                        </div>
                        <div className="text-white text-2xl">:</div>
                        <div className="text-center">
                            <div className="text-4xl font-bold text-white">
                            ...
                            <div className="text-white/60 text-xs">{t("seconds")}</div>
                        </div>
                    </div>
                </div>
            </div>
